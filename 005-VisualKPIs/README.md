# VisualKPIs - Visualización de KPIs de ventas con Python

## Descripción

VisualKPIs genera un reporte visual con gráficos clave para analizar ventas por categoría.  
Utiliza matplotlib y seaborn para crear gráficos de barras, líneas, boxplot e histogramas, y exporta los gráficos en formato PNG.
...
- Librerías: matplotlib, seaborn, pandas (instalables con `pip install matplotlib seaborn pandas`)

---

## Uso

1. Coloca el archivo `sales.csv` con datos de ventas en la carpeta `data/`.  
2. Ejecuta el script: python visual_kpis.py
