# 📁 Python Projects – Portafolio Técnico
...
### 🔬 Ciencia de Datos (`/ciencia_de_datos`)
Proyectos enfocados en el tratamiento, visualización y preparación de datos para su análisis y uso posterior. Incluye:
- Limpieza de datos (ETL)
- Visualización con `matplotlib`, `seaborn`, `plotly`
- Transformaciones con `pandas` y `numpy`
- Exportación a formatos para BI

### 🤖 Inteligencia Artificial (`/ia`)
Mini-proyectos centrados en modelos clásicos y modernos:
- Regresiones y clasificación con `scikit-learn`
