# SalesAnalyzer v1 - Análisis básico de ventas con Pandas

## Descripción

SalesAnalyzer es un script en Python que analiza datos de ventas por categoría, generando KPIs simples como totales, promedios y rankings.  
Exporta un reporte en Excel con hojas de resumen y top categorías.
...
- Librerías: pandas, openpyxl (se instalan con `pip install pandas openpyxl`)
...
2. Ejecuta el script: python sales_analyzer.py
